...
Elm.SvgGraphWidgets = Elm.SvgGraphWidgets || {};
Elm.SvgGraphWidgets.Main = Elm.SvgGraphWidgets.Main || {};
Elm.SvgGraphWidgets.Main.make = function (_elm) {
   "use strict";
   _elm.SvgGraphWidgets = _elm.SvgGraphWidgets || {};
   _elm.SvgGraphWidgets.Main = _elm.SvgGraphWidgets.Main || {};
   if (_elm.SvgGraphWidgets.Main.values)
   return _elm.SvgGraphWidgets.Main.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "SvgGraphWidgets.Main",
   $Basics = Elm.Basics.make(_elm),
   $Html = Elm.Html.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   ...
   _L.fromArray([A2($Svg.polygon,
                ...
                _L.fromArray([]))]));
   _elm.SvgGraphWidgets.Main.values = {_op: _op
                                      ,main: main};
   return _elm.SvgGraphWidgets.Main.values;
};
Elm.Task = Elm.Task || {};
